...
class Upload extends CI_Controller
{
    ...
    try {
      ...
      if (!force_download('uploads/laporan_'.$id_lap.'/skpd_'.$id_skpd.'/'.$nama_file,null)) {
        throw new Exception('File Tidak Ditemukan, atau Sudah Diarsipkan, Silakan Hubungi Pengelola');
      }
    } catch (Exception $e) {
      die ('Download Gagal: ' . $e->getMessage());
    }
