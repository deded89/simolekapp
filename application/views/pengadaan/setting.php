    ...
    <div class="col-md-3">
        ...
        ?>
                <select name="tahun_anggaran" class="form-control">
                    ...
                    <option value="2022" <?php echo $ta == '2022' ? 'selected' : '' ?>>2022</option>
                    <option value="2023" <?php echo $ta == '2023' ? 'selected' : '' ?>>2023</option>
                    <option value="2024" <?php echo $ta == '2024' ? 'selected' : '' ?>>2024</option>
                </select>
