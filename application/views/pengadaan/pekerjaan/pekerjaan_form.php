						...
						<div class="row">
							...
							<div class="col-sm-8">
								<select class="form-control" name="tahun_anggaran">
									<option value="2022" <?php echo $tahun_anggaran == '2022' ? 'selected' : '' ?>>2022</option>
									<option value="2021" <?php echo $tahun_anggaran == '2021' ? 'selected' : '' ?>>2021</option>
									<option value="2020" <?php echo $tahun_anggaran == '2020' ? 'selected' : '' ?>>2020</option>
									<option value="2019" <?php echo $tahun_anggaran == '2019' ? 'selected' : '' ?>>2019</option>
								</select>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-8">
								<div class="checkbox">
									<label>
										<input type="checkbox" name="multi_kontrak" value="ya" <?php echo isset($multi_kontrak) == 'ya' ? 'checked' : '' ?>>
										Multi Kontrak
									</label>
								</div>
							</div>
