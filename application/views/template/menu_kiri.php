      ...
      <?php  if ($this->ion_auth->in_group('admin')) //CEK APAKAH USER ADALAH ADMIN
      {
        ...
        <li class="treeview"><a href="#"><i class="fa fa-files-o"></i><span>Level Jabatan</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left fa-rotate-270 pull-right"></i>
          </span>
        </a>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        <?php if ($this->ion_auth->in_group('pengelola')){ ?>
              <li><a href="<?php echo base_url();?>pengadaan/report/filter"><i class="fa fa-folder-open"></i> Laporan TEPRA</a></li>
        <?php } ?>
...
<?php  if ($this->ion_auth->in_group('pengelola')) { ?>
  ...
  <li class="treeview">
    <a id="menu_lkpk" href="#">
      ...
      <span>LKPK</span>
      <span class="pull-right-container">
        <i class="fa fa-angle-left fa-rotate-270 pull-right" id="lkpk"></i>
      </span>
    </a>
    <ul class="treeview-menu">
      ...
      <li class="treeview">
        <a href="#"><i class="fa fa-folder "></i> Laporan
          <span class="pull-right-container">
            <i class="fa fa-angle-left fa-rotate-270 pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          <li><a href="<?php echo base_url();?>lkpk/ren_real/rfk_pemko"><i class="fa fa-circle-o"></i> RFK Pemko</a></li>
          <li><a href="<?php echo base_url();?>lkpk/ren_real/"><i class="fa fa-circle-o"></i> RFK SKPD</a></li>
          <li><a href="<?php echo base_url();?>lkpk/permasalahan/list"><i class="fa fa-circle-o"></i> Permasalahan</a></li>
        </ul>
      </li>

      <li class="treeview">
        <a href="#"><i class="fa fa-bar-chart"></i> Grafik Pemko
          <span class="pull-right-container">
            <i class="fa fa-angle-left fa-rotate-270 pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          <li><a href="<?php echo base_url();?>lkpk/kegiatan/grafik_pemko_keu"><i class="fa fa-circle-o"></i> Keuangan</a></li>
          <li><a href="<?php echo base_url();?>lkpk/kegiatan/grafik_pemko_fisik"><i class="fa fa-circle-o"></i> Fisik</a></li>
        </ul>
      </li>
