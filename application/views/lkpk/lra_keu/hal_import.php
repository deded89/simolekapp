	...
	<div class='col-xs-12'>
		<div class='box box-info'>
			<div class='box-header with-border bg-aqua'>
				<h3 class='box-title'>Form Import Nilai LRA</h3>
				<a href='<?php echo site_url('lkpk/lra_keu/hal_download_format') ?>'>
        ...
        <div class='box-body'>
            ...
            <h4><i class="icon fa fa-info"></i> Info :</h4>
						Untuk mengimport data LRA silakan :
            <ol>
          ...
          <div class='form-group'>
	        ...
	        <input type='hidden' name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
					<div class='col-xs-12 text-center'>
						<input type='submit' name='simpan' value='Import' class='btn btn-info'>
					</div>
				</div>
    	</form>
		</div>
