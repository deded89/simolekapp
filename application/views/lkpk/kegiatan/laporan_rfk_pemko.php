          ...
          <div class="col-xs-12">
            <div class="btn-group pull-right">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><?php echo anchor(site_url('lkpk/Ren_real/cetak_laporan_rfk_pemko/'.$bulan.'/'.$periode.'/'.$ta), 'Laporan RFK'); ?></li>
                <li><?php echo anchor(site_url('lkpk/Ren_real/cetak_tpp/'.$bulan.'/'.$periode.'/'.$ta), 'Perhitungan TPP SKPD'); ?></li>
              </ul>
            </div>
          </div>
        </div>
