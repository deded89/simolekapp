	...
	<div class="col-md-8 text-left">
		...
		<div class="btn-group">
			...
			<ul class="dropdown-menu" role="menu">
				...
				<li><?php echo anchor(site_url('lkpk/lra_keu/hal_download_format'), 'LRA'); ?></li>
			</ul>
		</div>
	</div>
</div>
					...
					<tbody>
						...
						foreach ($kegiatan_data as $kegiatan){
							...
							<tr>
								...
								?>
								<td><a href="<?php echo site_url('lkpk/kegiatan/ubah_pengecualian/'.$i.'/'.$kegiatan->id_kegiatan) ?>"><?php echo $dikecualikan ?></a></td>
